...
export default function AddProduct() {
    ...
    const publish = () => {
        ...
        if (title === "") {
            ...
            console.log("helo");
            Axios.post("http://localhost:3006/Productpublish", { Name: title, Description: Description, Price: price, Images: JSON.stringify(Images),Quantity:quantity }).then((response) => {
